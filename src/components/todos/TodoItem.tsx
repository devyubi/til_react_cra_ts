...
const TodoItem = ({ todo }: TodoItemProps) => {
  ...
  return (
    <li
      className={['flex items-center justify-between gap-2 rounded-lg border px-5 py-2'].join(' ')}
    >
      {isEdit ? (
        <div className="flex w-full items-center gap-2">
          <input
            ...
            className="flex-1 rounded-md border-neutral-300 bg-white px-2 py-1 outline-none focus:ring-brand dark:border-neutral-700 dark:bg-neutral-900"
          />
          <button
